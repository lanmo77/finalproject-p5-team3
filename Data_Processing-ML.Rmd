...
test = hack_games("jordan",teamdata)
plot_clippers = test[2]

games_clippers = test[1]

load("teamdata2.Rdata")
teamdata2 = process(teamdata2)
test = hack_games(c("howard","smith"),teamdata2)
plot_rockets = test[2]
games_rockets = test[1]

load("teamdata3.Rdata")
teamdata3 = process(teamdata3)
test = hack_games("drummond",teamdata3)
plot_detriot = test[2]
games_detriot = test[1]
...
#Can I predict based on free throws and hacking if they will win?
