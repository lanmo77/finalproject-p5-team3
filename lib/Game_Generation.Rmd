...
library(png)
library(grid)
img <- readPNG(system.file("img", "download.png", package="png"))
g <- rasterGrob(img, interpolate=TRUE)

ggplot(games_clippers, aes(x=count)) +
  geom_histogram(binwidth=.5, colour="red", fill="white") + 
  annotation_custom(g, xmin=-0, xmax=10, ymin=0, ymax=10) +
...
```{r}
b = ggplot(games_rockets, aes(x=count)) +
  geom_histogram(binwidth=.5, colour="red", fill="white") + 
...
c = ggplot(games_detriot, aes(x=count)) +
  geom_histogram(binwidth=.5, colour="red", fill="white") + 
