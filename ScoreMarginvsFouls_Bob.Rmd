...
ggplot(game, aes(game$SECINTOGAME, game$SCOREMARGIN)) + geom_line() + xlim(0, 2880) + xlab('Period') + scale_x_continuous(breaks = c(0, 720, 1440, 2160, 2880), labels = c('P1', 'P2', 'P3', 'P4', 'Final')) + ylab('Score Margin') + ggtitle('Spurs vs Clippers')
