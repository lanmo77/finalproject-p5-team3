...
data_score$V2 = paste("00",data_score$V2, sep = "")
test = filter(data_score,V2 %in% totalgamelist )
data_score$Hack = 0
data_score$Hack[data_score$V2%in%totalgamelist] = 1

team_list = c("Pistons","Clippers","Rockets")
#V4, V29
final_df = filter(data_score,V4%in%team_list | V29%in% team_list)
```